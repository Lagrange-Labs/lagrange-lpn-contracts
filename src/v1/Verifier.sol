...
contract Verifier {
    ...
    uint256 constant ALPHA_X =
        15452967106225180630805572706378030540731769319434194513417301256592532889983;
    uint256 constant ALPHA_Y =
        18890397532697068033365260561189968088703483956366561586291771313351071802091;

    // Groth16 beta point in G2 in powers of i
    uint256 constant BETA_NEG_X_0 =
        8073979993169887108787753906434599384450157629911065236767606436720322207461;
    uint256 constant BETA_NEG_X_1 =
        21038339868715132346797620224841568102093429003929766161356308631665627362645;
    uint256 constant BETA_NEG_Y_0 =
        10156994636661362715133685212233778525777176051395981229825217822397820164963;
    uint256 constant BETA_NEG_Y_1 =
        18753918091421509710524884736402174854812257720151949966092606546200839275576;

    // Groth16 gamma point in G2 in powers of i
    uint256 constant GAMMA_NEG_X_0 =
        19928151753140096411879794900754132525529196573016989369149562143492924724195;
    uint256 constant GAMMA_NEG_X_1 =
        14100244851620371287871661680435053880540182566978884964471398423033208935339;
    uint256 constant GAMMA_NEG_Y_0 =
        19059953800971818035169322304290603175672430760395749252295627599495366149058;
    uint256 constant GAMMA_NEG_Y_1 =
        5140096089283157524797488381533179555057151351079943451935718723168383730757;

    // Groth16 delta point in G2 in powers of i
    uint256 constant DELTA_NEG_X_0 =
        17282172512943678154558106012722092520715827973350673845806078849247435144875;
    uint256 constant DELTA_NEG_X_1 =
        14704034592837571344152162440511480576184520739671742011709232792997291346175;
    uint256 constant DELTA_NEG_Y_0 =
        16053410037003001232632619919107390215851841754833530596599313568153569086064;
    uint256 constant DELTA_NEG_Y_1 =
        3831197114088606220897875317951353527241249328239284229167061870604066624158;

    // Constant and public input points
    uint256 constant CONSTANT_X =
        4257402637112761235782750749738681060107757099939179488613453922313890947585;
    uint256 constant CONSTANT_Y =
        16640523854796239925384159032304731639939930455700630159861127880053096590865;
    uint256 constant PUB_0_X =
        7524020294009965038985106628605524852227543974139376414537136986257115273553;
    uint256 constant PUB_0_Y =
        7602283772342165647717014309595711801524290418676619972084600582052809064916;
    uint256 constant PUB_1_X =
        12727253091207374866501807151648083672731821783182235801824037204057371238562;
    uint256 constant PUB_1_Y =
        11433705588640001263857725899453802756519565592076157927429534746364489896819;
    uint256 constant PUB_2_X =
        3281490036664498081049671537389077887604609350206512009168919069426894448937;
    uint256 constant PUB_2_Y =
        8128877971934156540885128940274149136785066130210471767925993110230177126016;
    ...
    bytes32 constant CIRCUIT_DIGEST =
        0x244351d1d354b0c0e8cfe42d8091f1f6b5c62b07ee1d8dd800b31450b54c7ec3;
}
