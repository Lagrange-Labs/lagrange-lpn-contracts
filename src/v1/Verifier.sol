...
contract Verifier {
    ...
    uint256 constant ALPHA_X =
        810135448871874408292397180223713874572135135570365700308308452170650165057;
    uint256 constant ALPHA_Y =
        2607295631864201886288384085150706084614348908026967861660674876839122201604;

    // Groth16 beta point in G2 in powers of i
    uint256 constant BETA_NEG_X_0 =
        14166917269158642867733219066327895335211624957502593115449858100196395808424;
    uint256 constant BETA_NEG_X_1 =
        5626180183400450646723949702330956784023118317224192826614491867110637128045;
    uint256 constant BETA_NEG_Y_0 =
        14484613983598222250964293906748126741646441542935218904140857419150771603333;
    uint256 constant BETA_NEG_Y_1 =
        3708209860581305880396762437072437902004461354203816571802695591700502969523;

    // Groth16 gamma point in G2 in powers of i
    uint256 constant GAMMA_NEG_X_0 =
        12104724203179251545011186208711534891486406814923067233889451374892254095516;
    uint256 constant GAMMA_NEG_X_1 =
        10357776489584037164357715956146154249473781905251342314177080999672195914660;
    uint256 constant GAMMA_NEG_Y_0 =
        13363002098848690498241809591525498804295747175336932435055130317971898281840;
    uint256 constant GAMMA_NEG_Y_1 =
        17296646598178863710862010967514467450930493389745557304905599910020782852975;

    // Groth16 delta point in G2 in powers of i
    uint256 constant DELTA_NEG_X_0 =
        13226919771683087823113441953756609833242830578569775931647997673120207547041;
    uint256 constant DELTA_NEG_X_1 =
        8132121163730421081942883096074222381718567614236597316787064481108685861189;
    uint256 constant DELTA_NEG_Y_0 =
        11578046323317396215175430415896054730438613822036670229685092618583904029743;
    uint256 constant DELTA_NEG_Y_1 =
        93453449807417607988269018990087725599500988194600659299574076722115655772;

    // Constant and public input points
    uint256 constant CONSTANT_X =
        16374500139795868943574469510786350178452115259545797339143182798951271762840;
    uint256 constant CONSTANT_Y =
        7060182615226579276993398902567475100536219501363926157406825631314853132877;
    uint256 constant PUB_0_X =
        1317588890581510052996750870000975305568504609476614466184743320001335546301;
    uint256 constant PUB_0_Y =
        21659285724508420657575043092997875514283503390313708619469119991484926454853;
    uint256 constant PUB_1_X =
        14114355033210562463135266427035398737954826702977883217189167849204884283931;
    uint256 constant PUB_1_Y =
        19239727004983981481176996075318890277481042369300794872113722523340003963204;
    uint256 constant PUB_2_X =
        15991895832530270040547418213108174432348265639069710715467866217343802126764;
    uint256 constant PUB_2_Y =
        10033280470464206544965761042305015861277657308996592013878956107657252232807;
    ...
    bytes32 constant CIRCUIT_DIGEST =
        0x05ad949adf220f71a8ff02752599a7ed74fa4f6c8a30222b1c3ac18b4c5c22a2;
}
