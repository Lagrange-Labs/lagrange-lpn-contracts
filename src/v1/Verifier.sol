...
contract Verifier {
    ...
    uint256 constant ALPHA_X =
        13745683910991325447496990267329482756349463604595424813455554971512263191688;
    uint256 constant ALPHA_Y =
        2197234416413441931364059325650326686354386775253173753282236535362778435394;

    // Groth16 beta point in G2 in powers of i
    uint256 constant BETA_NEG_X_0 =
        13654868700699155203422378186449710060176287326399915722153696425480889946361;
    uint256 constant BETA_NEG_X_1 =
        17753439375089717168875051971173247102428814527786912232929008688624312007567;
    uint256 constant BETA_NEG_Y_0 =
        19832000161895068071901885841438549005701655433121315985685467618902582678793;
    uint256 constant BETA_NEG_Y_1 =
        7446344909034139161364798881759323317992552893864464734070455295114831628681;

    // Groth16 gamma point in G2 in powers of i
    uint256 constant GAMMA_NEG_X_0 =
        9838084891917874858961023994875523919584170767567135855305348714869010748300;
    uint256 constant GAMMA_NEG_X_1 =
        10149065737494309028669918701438241577370589747003299143982403311279100324281;
    uint256 constant GAMMA_NEG_Y_0 =
        4167523717491831669888329782406972215658256501382093090487210668225814057424;
    uint256 constant GAMMA_NEG_Y_1 =
        18968220167612811305391239988309439532369921218083994947423572825806808288019;

    // Groth16 delta point in G2 in powers of i
    uint256 constant DELTA_NEG_X_0 =
        3154253911209415459726628377730748813472111112018764028111049803999080117112;
    uint256 constant DELTA_NEG_X_1 =
        19100454290414376835460997658920844661271727165342030285277779764929817483743;
    uint256 constant DELTA_NEG_Y_0 =
        4111874040479838284970729979210532149112030556446273248988956113267434787762;
    uint256 constant DELTA_NEG_Y_1 =
        21321991497073018080608699411382876818661589658721298937874553805550882373030;

    // Constant and public input points
    uint256 constant CONSTANT_X =
        17905365230807783296200676947206184284689774345357537644553759615486371493010;
    uint256 constant CONSTANT_Y =
        16873370687639509514223899662116654915105728666253366908605535388166954824526;
    uint256 constant PUB_0_X =
        14758714784844418533366126948176398745872081478215796782806360272011608686863;
    uint256 constant PUB_0_Y =
        16260309147988424001707165573090613781074196888251054512827506203561456063953;
    uint256 constant PUB_1_X =
        11327523825939284521137974692361478486363439613026376556679072274365810338255;
    uint256 constant PUB_1_Y =
        17534803173433910179148330329809355377847770507000568009846949268359152301630;
    uint256 constant PUB_2_X =
        21523397432583690334919709310949067154318648617454378121905816815135871415398;
    uint256 constant PUB_2_Y =
        14685947023833848405660823993346810342750854706598799213740082713203096455743;
    ...
    bytes32 constant CIRCUIT_DIGEST =
        0x0db0af276391cdf932d3f91cb0b72fbf53903c4ffb95bb613f172c2f2bef74d3;
}
