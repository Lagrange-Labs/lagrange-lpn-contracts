...
library Groth16Verifier {
    ...
    uint256 constant ALPHA_X =
        2875744645601179976363844474093959170321451803468610749057361104388358291569;
    uint256 constant ALPHA_Y =
        9030985415484203529157134388375178884197023634925284841817030493863215311578;

    // Groth16 beta point in G2 in powers of i
    uint256 constant BETA_NEG_X_0 =
        4168542318372003188156028087884714088142844126831279036928527463314104009625;
    uint256 constant BETA_NEG_X_1 =
        5384258495492721486098880640446239757401296141806067034806601160302198090976;
    uint256 constant BETA_NEG_Y_0 =
        1561207354601639018543331975916306910309853318626727545899124391823831330521;
    uint256 constant BETA_NEG_Y_1 =
        20383936205862041072654599425036456432253475457020266865126981895931969642957;
    ...
    uint256 constant GAMMA_NEG_X_1 =
        10693921363568381157961078842123743771766278612605336854092820597802382701424;
    ...
    uint256 constant DELTA_NEG_X_0 =
        242531771162725810330185935192292698113063884016085472046645295503301133275;
    uint256 constant DELTA_NEG_X_1 =
        16291580441059584414836602944126194811398774433528842992651872049031028482753;
    uint256 constant DELTA_NEG_Y_0 =
        1417816254065265703615823536099938140877122992281837643943740324053939897364;
    uint256 constant DELTA_NEG_Y_1 =
        14030578855720338723602878644561073910674875557052687059892517557596226896548;

    // Constant and public input points
    uint256 constant CONSTANT_X =
        5202978798150463655908570029891721340884651522916353899726471113111423929342;
    uint256 constant CONSTANT_Y =
        14982591606621159141329318953795543458568319795981297660099879207303254040809;
    uint256 constant PUB_0_X =
        14296192090556038838045209301731774710680090775075355984322587980761493543904;
    uint256 constant PUB_0_Y =
        19601706790272468704913839562858335792111985806205849666707512679510610253899;
    uint256 constant PUB_1_X =
        6556458653007261924416086804438178193077444885416364865223485598120055942696;
    uint256 constant PUB_1_Y =
        286212824975773989378954189604165017341082476242589668187439098069840023246;
    uint256 constant PUB_2_X =
        13430983197622959976950587585456204167851174705647144133972047650438831094215;
    uint256 constant PUB_2_Y =
        7842741937998900944887201062754035088483914707422731211588620224038761132415;
    ...
    bytes32 constant CIRCUIT_DIGEST =
        0x2f220073107d5d15dd938ce95b310688567a9c1610677513ef91fd0836afc496;
}
