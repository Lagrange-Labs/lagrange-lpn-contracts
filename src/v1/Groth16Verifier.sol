...
library Groth16Verifier {
    ...
    uint256 constant ALPHA_X =
        6024071952265975677152175453412526653627726645968636292583429765393983297857;
    uint256 constant ALPHA_Y =
        4482220429959631620532240642880910623363726241050478585346511271521582161112;

    // Groth16 beta point in G2 in powers of i
    uint256 constant BETA_NEG_X_0 =
        20624608874079988813020598725276413235247731061250260856536578009280479008011;
    uint256 constant BETA_NEG_X_1 =
        3355763006039718529400659714275195750740811806978577903597853699826621720113;
    uint256 constant BETA_NEG_Y_0 =
        9042747064398162821436684003782937630748496364281716015280009609546612846483;
    uint256 constant BETA_NEG_Y_1 =
        16020513881966435554541106571726652145039429595909913764648770267188103916964;

    // Groth16 gamma point in G2 in powers of i
    uint256 constant GAMMA_NEG_X_0 =
        18315522500080280402364996330619163248382403928262087406936064793087781503045;
    uint256 constant GAMMA_NEG_X_1 =
        21878831974328515247059163500286390872058374283716751317969390405675593246161;
    uint256 constant GAMMA_NEG_Y_0 =
        13515367120039247582194326023498777139827845935167458561256354896977292176944;
    uint256 constant GAMMA_NEG_Y_1 =
        418635559329977433400516306052272023414770136285767624184505350905426718471;

    // Groth16 delta point in G2 in powers of i
    uint256 constant DELTA_NEG_X_0 =
        5952679876200127408658061142422634968560388176936492073048278091207829454755;
    uint256 constant DELTA_NEG_X_1 =
        5615499663850748688779720066818927625801317905705226319536979715273141115892;
    uint256 constant DELTA_NEG_Y_0 =
        19792226113831778471562919897347356145268675104778223238957552520892628445762;
    uint256 constant DELTA_NEG_Y_1 =
        947505837444868816344225400234598062664253093044005427263513520887441190880;

    // Constant and public input points
    uint256 constant CONSTANT_X =
        3306353164244819490530940963796854847869417826828060997205450153792646979028;
    uint256 constant CONSTANT_Y =
        19802127766829753001942197782031579860550202906950239008195778142871637543536;
    uint256 constant PUB_0_X =
        21639645591309795006551007937550068932634937798793047088362969064930165658739;
    uint256 constant PUB_0_Y =
        15925147511039699221891040516254696927948001056074831536282214001897484779097;
    uint256 constant PUB_1_X =
        12404632575238322944146700642196069561300582900980567075474907164013691938233;
    uint256 constant PUB_1_Y =
        8261298890297124947098955640306351295436696906367119735588565328353293808124;
    uint256 constant PUB_2_X =
        1939035161101220611006650156920677597313106031865070385946345066294692265520;
    uint256 constant PUB_2_Y =
        12161082778789072175161882812522114909116700370827872498174057771398544674523;
