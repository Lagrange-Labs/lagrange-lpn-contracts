...
library Groth16Verifier {
    ...
    uint256 constant ALPHA_X =
        17147803709216217885360176122179385221571622753819427779045553525647053763865;
    uint256 constant ALPHA_Y =
        6428154142890871476334556257742031748980549201020241398224139996777026984622;

    // Groth16 beta point in G2 in powers of i
    uint256 constant BETA_NEG_X_0 =
        9696074276199487062479757663961462518812285712076970554882629851872339714933;
    uint256 constant BETA_NEG_X_1 =
        10317554438302974149102889926068613712310853878102173555115146863190550190088;
    uint256 constant BETA_NEG_Y_0 =
        4598915570945618127034488694570383342033535084326181773299383523717841486640;
    uint256 constant BETA_NEG_Y_1 =
        5610883690225369040409647296649563085539070244316766969730947227732445050692;

    // Groth16 gamma point in G2 in powers of i
    uint256 constant GAMMA_NEG_X_0 =
        20051153348425168804669945418360858855904177545342546768015198917632188225827;
    uint256 constant GAMMA_NEG_X_1 =
        1614158574623934789180552298247529110513970372088628716675718656286179016565;
    uint256 constant GAMMA_NEG_Y_0 =
        19621217599516768793762210741615672325264800442786817197389149740599330603939;
    uint256 constant GAMMA_NEG_Y_1 =
        20771678534955984918820686147316847370662291014920758428729347022170473746187;

    // Groth16 delta point in G2 in powers of i
    uint256 constant DELTA_NEG_X_0 =
        19984647686234611737900606895300900549685344148258118514514453979602725233306;
    uint256 constant DELTA_NEG_X_1 =
        699596239388804701943616008439871113427931905835764267452168769585235205558;
    uint256 constant DELTA_NEG_Y_0 =
        13627284856870667553502264420314018701608312432800176293668552701983690889889;
    uint256 constant DELTA_NEG_Y_1 =
        2099399429572579877650717349477996964532486584302305449122400970503894903405;

    // Constant and public input points
    uint256 constant CONSTANT_X =
        389057303405133363272603001984927041239791446253793533564642545401220255772;
    uint256 constant CONSTANT_Y =
        5040859725209486410369535459586588140773447622449298865073109535337598369375;
    uint256 constant PUB_0_X =
        10654767951853045402464180091262160517842718529328857173752134148492388614611;
    uint256 constant PUB_0_Y =
        12033761971627784807539185038169308552973107174082237638926188839811110519022;
    uint256 constant PUB_1_X =
        664096918625623988579631532138700776200959506481493608255115587262870586784;
    uint256 constant PUB_1_Y =
        899829632749382413649582644039403394979993790894358687993313993612336383206;
    uint256 constant PUB_2_X =
        3948351774660884483338136883902310186036119434524853131595847412318038233922;
    uint256 constant PUB_2_Y =
        20537226442170893777871755751448612694352569092766069841181851082497254099773;
    ...
    bytes32 constant CIRCUIT_DIGEST =
        0x2a233318e363ad08947529660deb259ccf101cb76e65a3c57b5187028d15ce9d;
}
