...
library Groth16Verifier {
    ...
    uint256 constant ALPHA_X =
        21487487022262406933389489699731616686425456194977793174707877658669430315987;
    uint256 constant ALPHA_Y =
        761018373122159215393710824739673136307311239096662778024038059170453863317;

    // Groth16 beta point in G2 in powers of i
    uint256 constant BETA_NEG_X_0 =
        7956286145411028693160168257965412061764259814376439390936354004521348541638;
    uint256 constant BETA_NEG_X_1 =
        7314409229398514406469583798799343296957126426248478634098532500330369289597;
    uint256 constant BETA_NEG_Y_0 =
        3045216755903210369616241151394844076890160140429858169919292919569713542283;
    uint256 constant BETA_NEG_Y_1 =
        3360850277460232464857041626085722183464010366295688802754987497940643042754;

    // Groth16 gamma point in G2 in powers of i
    uint256 constant GAMMA_NEG_X_0 =
        19841818955168614219981340529804418993728792157315760531371468138569667914101;
    uint256 constant GAMMA_NEG_X_1 =
        20013433280127706859938174428401985938136464016804029608868832604421934923725;
    uint256 constant GAMMA_NEG_Y_0 =
        17194687031476649191827688592673301891795019893553823103481163005823265063063;
    uint256 constant GAMMA_NEG_Y_1 =
        4530631915008779244086446159417098835743301802223069835363712899869960264384;

    // Groth16 delta point in G2 in powers of i
    uint256 constant DELTA_NEG_X_0 =
        13958317008089515172652341834729932083643920497293860532887130409656902546733;
    uint256 constant DELTA_NEG_X_1 =
        19379040081823514791934433839813556180366443404751547909284929030194830417875;
    uint256 constant DELTA_NEG_Y_0 =
        2607386660752217526635666545591830419658071600843688178590960544550345128326;
    uint256 constant DELTA_NEG_Y_1 =
        6299953606948309157177021355464615153705600488053248901750234231786221722167;

    // Constant and public input points
    uint256 constant CONSTANT_X =
        18086614200273574725892472585063553729385615687542349515562158268721624272819;
    uint256 constant CONSTANT_Y =
        4288311201722717106155603978327958614257060199197750461346054823012363893539;
    uint256 constant PUB_0_X =
        10794045583615799740575146942040092191059374574427810964583992043159888459912;
    uint256 constant PUB_0_Y =
        76199957885901113964064746399270234814216620858270300734350673745649827618;
    uint256 constant PUB_1_X =
        7835528690476050612386805669914667540790052312093547716674624474845794217156;
    uint256 constant PUB_1_Y =
        14498978482065457876515085319114952811806255556254230557420331294090044710268;
    uint256 constant PUB_2_X =
        14602953569089347912694722303208701961069042434071743003196484012524684572854;
    uint256 constant PUB_2_Y =
        10289760482405406090277995246781720451867227000569285710450176486831522726857;
    ...
    bytes32 constant CIRCUIT_DIGEST =
        0x217913d6b742e666ba2d8ec4d7b174526757c49d2bc2eb2751f2b83e891cdd47;
}
