...
library Groth16Verifier {
    ...
    uint256 constant ALPHA_X =
        6893492585435788424455286859283300228781733027125754905633368804056724173274;
    uint256 constant ALPHA_Y =
        11364301589083281105003289663085376163842726237065683132052344322598483759124;

    // Groth16 beta point in G2 in powers of i
    uint256 constant BETA_NEG_X_0 =
        16516788279400682166032765309229566766328355115718297637616185642029734361336;
    uint256 constant BETA_NEG_X_1 =
        11081905545865585267961234952291046874671937028350698705213194377851499915189;
    uint256 constant BETA_NEG_Y_0 =
        19536656991746308613614954591513671340028296771241426851450033035885395357183;
    uint256 constant BETA_NEG_Y_1 =
        19259749522490399000590251559011105301776792752593175610099881675453802935581;

    // Groth16 gamma point in G2 in powers of i
    uint256 constant GAMMA_NEG_X_0 =
        17008226978521122677878726864792685603525872199049202320612623832840697466090;
    uint256 constant GAMMA_NEG_X_1 =
        10273722862621454514056842606355907877349261495220901245509299231393618860297;
    uint256 constant GAMMA_NEG_Y_0 =
        3347946337444495905198235065966354325777376817310911909855984668660739697550;
    uint256 constant GAMMA_NEG_Y_1 =
        11154213952587671201401074396138945411486583946553035343687990916945936179548;

    // Groth16 delta point in G2 in powers of i
    uint256 constant DELTA_NEG_X_0 =
        17686597324079395252783389703173111190057941001055792737650351506391097927346;
    uint256 constant DELTA_NEG_X_1 =
        1374152243628838799174756822473759986196380696307474274561571319577838827913;
    uint256 constant DELTA_NEG_Y_0 =
        1342082659316856036200223828407436153825404634434604089310310677785036414422;
    uint256 constant DELTA_NEG_Y_1 =
        13206137176894361462501370289942571981666438091279581744327981455486204496951;

    // Constant and public input points
    uint256 constant CONSTANT_X =
        19165423996564134981532378354040198980617676069318690864786931154242665622354;
    uint256 constant CONSTANT_Y =
        1182822068551125187420167236728660283842645574857549632365783988377215699192;
    uint256 constant PUB_0_X =
        21562035807437387541942112621145492351972331693936065089617041160827587413775;
    uint256 constant PUB_0_Y =
        8768724041201575460091806363025744725287619878160203954533364229812855881792;
    uint256 constant PUB_1_X =
        4816086571895082739779948523714644153806913778328714594494118945470541531555;
    uint256 constant PUB_1_Y =
        163576468698807621747216725509420635428635445455438522277894649904505917134;
    uint256 constant PUB_2_X =
        21541878284534217180450306978164580727345161059925771685115734795143976786729;
    uint256 constant PUB_2_Y =
        10866635153984933781352926772502140380899599079674700203977146953283152755340;
    ...
    function verifyQuery(bytes memory pis, Query memory query) internal pure {
        ...
        address contract_address =
            convertToAddress(pis, PI_CONTRACT_ADDR_OFFSET);
        require(
