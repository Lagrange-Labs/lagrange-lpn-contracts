...
library Groth16Verifier {
    ...
    uint256 constant ALPHA_X =
        12943109183827362903786436947433810452917307457003830797806376526754268667671;
    uint256 constant ALPHA_Y =
        21534529833569098508572703764788361154249055939640593856131487470663091269427;

    // Groth16 beta point in G2 in powers of i
    uint256 constant BETA_NEG_X_0 =
        21188596153828708309085707426963053885598629445290284753409978107078038028444;
    uint256 constant BETA_NEG_X_1 =
        1640717442039365847611469638803277502009702687342679445216865548011687603497;
    uint256 constant BETA_NEG_Y_0 =
        19955534775726346252148828477751129601698970124917199375657645802069286470818;
    uint256 constant BETA_NEG_Y_1 =
        954360129838889112423747458621829088814010831375422417821150028852035789114;

    // Groth16 gamma point in G2 in powers of i
    uint256 constant GAMMA_NEG_X_0 =
        19310928325717553453527143419384356678721223784035847590363294885756604874420;
    uint256 constant GAMMA_NEG_X_1 =
        20406332704506232201572941459177927655118470704714168135262312155199730229383;
    uint256 constant GAMMA_NEG_Y_0 =
        18614229110904764674061520408830319283354298750043091455839850404482296144216;
    uint256 constant GAMMA_NEG_Y_1 =
        244211543192900983134067776901389072597128320847614359756796260644348360565;

    // Groth16 delta point in G2 in powers of i
    uint256 constant DELTA_NEG_X_0 =
        21582490733694068809990723968986091803612683619772582023317100318781294182536;
    uint256 constant DELTA_NEG_X_1 =
        20101859198669682499168603132288869667842194895548883612670107968764749810303;
    uint256 constant DELTA_NEG_Y_0 =
        3114327041013885267537968074404838460792004498819611705663697633109222512605;
    uint256 constant DELTA_NEG_Y_1 =
        10861053443946565774656551292227414632109490721864908302533651038690868637028;

    // Constant and public input points
    uint256 constant CONSTANT_X =
        19565614971719670596090972389829821175205029619337341446955227609050352740639;
    uint256 constant CONSTANT_Y =
        289037803597894665596706956316185795694618387587318815984259284279261883161;
    uint256 constant PUB_0_X =
        19737435711961295528210400017045269171049913458122334318854112443936137242552;
    uint256 constant PUB_0_Y =
        16535685386716464741127381456774891066661684592197730391815607349789996139000;
    uint256 constant PUB_1_X =
        10662326262854473986068564406200749968146446710133149557625782824979708906472;
    uint256 constant PUB_1_Y =
        9786883463200603536924008176113354737608839660605302927350841442508490123918;
    uint256 constant PUB_2_X =
        7237199111577903973981097514353850016364678588745545692844385275694525819490;
    uint256 constant PUB_2_Y =
        8511811181094557882807651892581231934929823496293318240193425613406818349255;
    ...
    bytes32 constant CIRCUIT_DIGEST =
        0x0fe118d8d50f1044b6a1d4de6ae2ce38de7a7a07c255e9884e646756439e2f29;
}
