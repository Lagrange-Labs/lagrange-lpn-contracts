...
library Groth16Verifier {
    ...
    uint256 constant ALPHA_X =
        21240516409640074159992156247830471303318613709451580478046683288261228863107;
    uint256 constant ALPHA_Y =
        2863273447500662726540589889538139326922297979347073835004930101072635702167;

    // Groth16 beta point in G2 in powers of i
    uint256 constant BETA_NEG_X_0 =
        9622943318700839915620502627492638317225878995261086935391208320726699696091;
    uint256 constant BETA_NEG_X_1 =
        1915355384824813121540430733246104328063604536133804493912662899585912286885;
    uint256 constant BETA_NEG_Y_0 =
        3486640936748288141201090521922077045652997587123991678093958762361053217452;
    uint256 constant BETA_NEG_Y_1 =
        4261055074226999291012216260069736274638560654934039929903546784360386024495;

    // Groth16 gamma point in G2 in powers of i
    uint256 constant GAMMA_NEG_X_0 =
        20446168008593010703506739414396747911537528802810400810987576378139948230883;
    uint256 constant GAMMA_NEG_X_1 =
        9938344830880059644640837524255824539803536618795158361598623007532675287270;
    uint256 constant GAMMA_NEG_Y_0 =
        13241561899532022044356916790112186784480090603133498253236447851344817614755;
    uint256 constant GAMMA_NEG_Y_1 =
        15033979315717992650539636793642983809038285873892513756311692973714921200820;

    // Groth16 delta point in G2 in powers of i
    uint256 constant DELTA_NEG_X_0 =
        5057233726553684200414545040369972586840254254249332799679602273145725120188;
    uint256 constant DELTA_NEG_X_1 =
        21375177356820717456125639885952559565504618269990203805706128410408836720813;
    uint256 constant DELTA_NEG_Y_0 =
        2565437463233336066732079359136884404434383328608424217723037536374408961503;
    uint256 constant DELTA_NEG_Y_1 =
        1629531920701405296769355033111374027860865665297386448100611738795830922588;

    // Constant and public input points
    uint256 constant CONSTANT_X =
        15872046867362446613037110867505735869353943781323041265037366348995732996229;
    uint256 constant CONSTANT_Y =
        18204743816605744266917295311598586630045827491127366037081199919910134153346;
    uint256 constant PUB_0_X =
        1525128681295354430452259933683986301192768679565049058446925383742101820316;
    uint256 constant PUB_0_Y =
        18569965592898315534774698044305249715166051666906970536384326941971730868645;
    uint256 constant PUB_1_X =
        13655321137774104281658230437921903580259464705088947146801086009545440362501;
    uint256 constant PUB_1_Y =
        2605156225401539698855190068336862170045688673403865187991787913073163054778;
    uint256 constant PUB_2_X =
        11780442367952134545983279023737732821613270225534356887452597683195440415168;
    uint256 constant PUB_2_Y =
        1440868210672729738328406784295586301132697827683223028987611298375453327290;
    ...
    bytes32 constant CIRCUIT_DIGEST =
        0x2816759d0f7a8cd499354b2f471d63c78d15c2ddb925f8ca46c3ed129ae82807;
}
