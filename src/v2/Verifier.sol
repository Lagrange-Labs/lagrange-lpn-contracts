...
contract Verifier {
    ...
    uint256 constant ALPHA_X =
        1818716353763789945838623062646945745152945228289405444860827318095528011350;
    uint256 constant ALPHA_Y =
        13931892890035811205544570538891566481312362448728710202008279908427007098806;

    // Groth16 beta point in G2 in powers of i
    uint256 constant BETA_NEG_X_0 =
        4904092215920951006731325532630424604767046756027819397837689375283419259078;
    uint256 constant BETA_NEG_X_1 =
        20430358639225627220255222849381190047559024983655738915302881725013411464189;
    uint256 constant BETA_NEG_Y_0 =
        21002918967252391766836801443351194604751669619222545644320733513415426555731;
    uint256 constant BETA_NEG_Y_1 =
        9720305416544007109494892562326378605839363499963661764240604627145884810175;

    // Groth16 gamma point in G2 in powers of i
    uint256 constant GAMMA_NEG_X_0 =
        8539766908241464314060790686374589200487395263706894844265464825911323869427;
    uint256 constant GAMMA_NEG_X_1 =
        1881538722907444986118460678921321664868926055048206533309682045451620396981;
    uint256 constant GAMMA_NEG_Y_0 =
        19121099247131757078805109681535051881998159240457436027925143716791226497252;
    uint256 constant GAMMA_NEG_Y_1 =
        8360391034864832828927423169650429153928973450908684223105958876063419018783;

    // Groth16 delta point in G2 in powers of i
    uint256 constant DELTA_NEG_X_0 =
        10658444238576245616202436187971221033211329686076131526848151020776537843715;
    uint256 constant DELTA_NEG_X_1 =
        20512521242780151506931708674267144694409807071392388063406377739898764842467;
    uint256 constant DELTA_NEG_Y_0 =
        8110383728871407204728746952293898176167748570156614435957381824634244101960;
    uint256 constant DELTA_NEG_Y_1 =
        20341218502675475455066735178620825964911304533040166744637140847819431678403;

    // Constant and public input points
    uint256 constant CONSTANT_X =
        21858494809957380305007871131022119510298971835339012205856618710739362749532;
    uint256 constant CONSTANT_Y =
        9958814867892513842045056536311527539418440883599551535385670167827389092420;
    uint256 constant PUB_0_X =
        7781452450904195064740557598920156194169412544156526219942789812138159045756;
    uint256 constant PUB_0_Y =
        14421121266982677760958017420128785687912526943908140817629531302159396994926;
    uint256 constant PUB_1_X =
        5160784669401490572878379112681127086847134721753352686527423142205313750695;
    uint256 constant PUB_1_Y =
        13494651069189177222892751304221165775878075945302109088400943972366534902646;
    uint256 constant PUB_2_X =
        16277792322813078558887413548539599583097592821485890719497839415653206500282;
    uint256 constant PUB_2_Y =
        7464552917862153388253314170833825407033477716259969636268552669757844902711;
    ...
    bytes32 constant CIRCUIT_DIGEST =
        0x21c6de9dd017326c1635fe8968a992e9a2a3dc360df7078f8d27837f556ef9f1;
}
